...
class PendingScreenFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = PendingScreenFragment()
    }

    private lateinit var viewModel: PendingScreenViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(PendingScreenViewModel::class.java)
