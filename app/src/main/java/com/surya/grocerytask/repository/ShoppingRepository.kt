...
class ShoppingRepository @Inject constructor(
    ...
    suspend fun updateShoppingListAndProducts(shoppingList: ShoppingList, shoppingProducts: List<ShoppingProducts>) {
    ...
    suspend fun scheduleReminderForShoppingList(shoppingListId: Long, reminderTime: Long) {
        shoppingListDB.getShoppingDAO().scheduleReminderForShoppingList(shoppingListId, reminderTime)
    }
